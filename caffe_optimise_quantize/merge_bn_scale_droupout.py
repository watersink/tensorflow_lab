...
import sys
#caffe_root = '/data/MobileNet-YOLO-master/'
caffe_root = '/data/caffe-enet/'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='deploy.prototxt')
    parser.add_argument('--weights', type=str, default='yolov3.caffemodel')
    parser.add_argument('--output_model',default="deploy_mergebn.prototxt")
    parser.add_argument('--output_weights',default="yolov3_mergebn.caffemodel")
